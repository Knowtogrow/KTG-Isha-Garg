...
public class ScoreActivity extends AppCompatActivity implements MyRecyclerViewAdapter.ItemClickListener{
    private resultslib mResultsLibrary = new resultslib();
    private  fieldName mfieldName = new fieldName();
    RecyclerView recyclerView;
    MyRecyclerViewAdapter adapter;
    ArrayList<Model> models  = new ArrayList();
    private TextView resultInterestPercentage;
...
//        getSupportActionBar().setTitle("Your Interest Score");
        ...
        if(contain.contains(Integer.parseInt(String.valueOf(mQuestionChoice.get(21)))) && contain.contains(Integer.parseInt(String.valueOf(mQuestionChoice.get(31)))) && contain.contains(Integer.parseInt(String.valueOf(mQuestionChoice.get(59)))) && contain.contains(Integer.parseInt(String.valueOf(mQuestionChoice.get(45)))) && contain.contains(Integer.parseInt(String.valueOf(mQuestionChoice.get(44)))))
        {
...
//            resultContent.setText(resultContent.getText() + getResources().getString(R.string.interestpercentage) +
//                    total.get(i) + getResources().getString(R.string.percentage) +"\n" +mResultsLibrary.getDescription(descending[i])+ "\n");
//           resultContent.setText(resultContent.getText() + "" + total.get(i));
            Model model = new Model();
            model.setName(mfieldName.getDescription(descending[i]));
            model.setPer(total.get(i));
            model.setDesc(mResultsLibrary.getDescription(descending[i]));
            models.add(model);
        }
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new MyRecyclerViewAdapter(this, models);
        adapter.setClickListener(this);
        recyclerView.setAdapter(adapter);
    }
    @Override
    public void onBackPressed() {
        Intent intent = new Intent(this, MainActivity_Apti.class);
